...
and actively work on full stack projects to understand real-world system design.
...
- Worked on real-world features like order flow and state management  
...
- Converted Figma designs into clean, reusable components  
- Integrated APIs and ensured cross-device compatibility  

**Web Developer Intern – UniConverge**  
...
- Continuously learning backend systems and architecture  
